...
namespace Warmerise.Map
{
    ...
    public class WMWaterScript : MonoBehaviour
    {
        ...
        public void OnWillRenderObject()
        {
            ...
            //Instantiate reflection and refraction cameras
            ...
            if (m_ReflectionTexture)
            {
                rndr.sharedMaterial.SetTexture("_ReflectionTex", m_ReflectionTexture);
            }

            //print("Rendering water");
            if (!enabled || !rndr || !rndr.sharedMaterial ||
                !rndr.enabled)
            {
                return;
            }
            ...
            /*if (mode >= WaterMode.Refractive)
            {
                ...
                rndr.sharedMaterial.SetTexture("_RefractionTex", m_RefractionTexture);
            }*/
        ...
        void Update()
        {
            ...
            Material mat = rndr.sharedMaterial;
            if (!mat)
            {
                return;
            }
        ...
        {
            if (/*!SystemInfo.supportsRenderTextures ||*/ !rndr)
            {
        ...
        void OnDestroy()
        {
            //print("Water script was destroyed");
            if (reflectionCamera)
            {
            ...
            if (refractionCamera)
            {
                DestroyImmediate(refractionCamera);
            }
            if (m_ReflectionTexture)
            {
                DestroyImmediate(m_ReflectionTexture);
